    ...
    <div className="auth-page">
      ...
      <div className="auth-page__background">
        <video autoPlay loop muted playsInline className="auth-page__bg-video">
          <source
            src="https://cdn.prod.website-files.com/696604acc25b997c8d38dea0%2F6972f94d06903d01be568e98_luffu-background-video-v2_mp4.mp4"
            type="video/mp4"
          />
          <source
            src="https://cdn.prod.website-files.com/696604acc25b997c8d38dea0%2F6972f94d06903d01be568e98_luffu-background-video-v2_webm.webm"
            type="video/webm"
          />
        </video>
      ...
      <div className="auth-page__content">
        ...
        <div className="auth-card">
          ...
          <p className="auth-card__subtitle">Log in to your Luffu account</p>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="auth-form__forgot">
              <Link to="#" className="auth-form__link">Forgot password?</Link>
            </div>
